...
d\. [MCMC tab:]{.underline} Set chain length: 5,000,000 (i.e. 5 million. If it's too slow on your computer, you could reduce this to 1 million - the longer you run the MCMC for the most likely it is to converge); Tracelog file name: Cyanistes.log; Tree log file: "Cyanistes.trees"
